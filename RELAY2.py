...
relay_topic='pr/home/5976397/sts' # dubscribe to topic that DHT public
global ON
ON = False
...
class Mqtt_client():
    ...
    def on_message(self, client, userdata, msg):
        ...
        temp =m_decode.split("Temperature: ")[1].split(" Humidity")[0]
        #Temperature: 22.8 Humidity: 75.0
        floatTemp=float(temp)

        print(floatTemp)
        
        if floatTemp>=45.5:  #TURN ON
            ON=False
            mainwin.connectionDock.update_btn_state(m_decode)
        elif floatTemp<45.5: #TURN OFF
            ON=True
            mainwin.connectionDock.update_btn_state(m_decode)
